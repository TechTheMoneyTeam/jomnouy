              ...
              <div className="absolute z-10 mt-1 w-56 bg-white rounded-md shadow-lg">
                <div className="py-1">
                  <button
                    ...
                    className={`block px-4 py-2 text-sm w-full text-left ${selectedProject === 'all' ? 'bg-orange-100 text-orange-700' : 'text-gray-700'
                      }`}
                  >
                    Overall (All Projects)
                  </button>
                  ...
                  {projects.map(project => (
                    <button
                      ...
                      className={`block px-4 py-2 text-sm w-full text-left ${selectedProject === project.project_id ? 'bg-orange-100 text-orange-700' : 'text-gray-700'
                        }`}
                    >
                      {project.title}
                    </button>
